...
import com.example.wordsapp.model.Item
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //val letterId = intent?.extras?.getString(StringConstants.LETTER).toString()
        val obj = intent?.extras?.get(StringConstants.LETTER) as Item
        val letterId=obj.letter
        Log.d("check",letterId)
